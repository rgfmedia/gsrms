			...
			<div class="menu_nav">
				<ul>
				     <li><a href="Home.php">Home</a></li>
					 					<li class="active"><a href="calendar.php">GS Calendar</a></li>
          ...
          <thead>
            <tr bgcolor="0c2883" style="margin-bottom:10px;">
					            	...
					            	<?php if ($_SESSION['SESS_FIRST_NAME']=="admin"){
					  					  echo '<a rel="facebox" href="addcalendar.php"><input name="button" type="button" style="cursor:pointer;" value="ADD FILES"/></a>';
					  					  }
					  					  ?>
					  			</th>
				...
				while($row = mysql_fetch_array($result))
				  {
					echo '<tr>';
					  echo '<td>'.$row['cals'].'</td>';
					  if ($_SESSION['SESS_FIRST_NAME']=="admin"){
					  echo '<td><div align="center">'.'<a href=download.php?id=' . $row["content"] .'&amp;downloadby=argie>download</a>'.' | '.'<a rel="facebox" href=editcalendar.php?id=' . $row["cal_id"] .'><img src="images/b_edit.png" /></a>'.' </div></td>';
					echo '</tr>';
						}
					  if ($_SESSION['SESS_FIRST_NAME']!="admin"){
