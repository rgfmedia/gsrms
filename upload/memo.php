			...
			<div class="menu_nav">
				<ul>
				    <li><a href="Home.php">Home</a></li>
															<li  class="active"><a href="memo.php">Memo</a></li>
															<li><a href="commu.php">Communication </a></li>
															<li><a href="forms.php">Forms</a></li>
															<li><a href="research.php">Research</a></li>
															<li><a href="rde.php">Faculty Profile</a></li>
...
<!--
		  ...
		  echo '<a rel="facebox" href="addmemo.php">Add Memo Files</a>';
		  }
		  ?>
-->
...
<!--<div id="search">
        		...
        		&nbsp;&nbsp;&nbsp;<label for="filter"><font color="blue" size=3>Search</font></label> <input type="text" name="filter" value="" id="filter" size="35"/>
...
<table cellpadding="1" cellspacing="1" id="resultTable">
          <thead>
          	...
          	<th align=left>
          	<?php if ($_SESSION['SESS_FIRST_NAME']=="admin"){
					  echo '<a rel="facebox" href="addmemo.php"><input name="button" type="button" style="cursor:pointer;" value="ADD MEMO FILES"/></a>';
					  }
					  ?>
			</th>
            ...
            <tr bgcolor="#0e39c2" style="margin-bottom:10px;">
              ...
              <th> <font color="white">Official</font></th>
				...
				while($row = mysql_fetch_array($result))
				  {
					echo '<tr>';
					  ...
					  echo '<td><div align="center">'.'<a href=download.php?id=' . $row["content"] .'&amp;downloadby=argie>download</a>'.' | '.'<a rel="facebox" href=editmemo.php?id=' . $row["memo_id"] .'><img src="images/b_edit.png" /></a>'.' </div></td>';
					echo '</tr>';
						}
					  if ($_SESSION['SESS_FIRST_NAME']!="admin"){
