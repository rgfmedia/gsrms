          ...
          <thead>
            ...
            <tr bgcolor="0c2883" style="margin-bottom:10px;">
					            	...
					            	<?php if ($_SESSION['SESS_FIRST_NAME']=="admin"){
					  					  echo '<a rel="facebox" href="addresearch.php"><input name="button" type="button" style="cursor:pointer;" value="ADD FILES"/></a>';
					  					  }
					  					  ?>
					  			</th>
            ...
            <tr bgcolor="#0e39c2" style="margin-bottom:10px;">
              ...
              <th> <font color="white">Proponents</font> </th>
				...
				while($row = mysql_fetch_array($result))
				  {
					echo '<tr>';
					  ...
					  if ($_SESSION['SESS_FIRST_NAME']=="admin"){
					  echo '<td><div align="center">'.'<a href=download.php?id=' . $row["content"] .'&amp;downloadby=argie>download</a>'.' | '.'<a rel="facebox" href=editmemo.php?id=' . $row["res_id"] .'><img src="images/b_edit.png" /></a>'.' </div></td>';
					echo '</tr>';
						}
					  if ($_SESSION['SESS_FIRST_NAME']!="admin"){
