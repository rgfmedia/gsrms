...
<table cellpadding="1" cellspacing="1" id="resultTable">
          <thead>
            <tr bgcolor="0c2883" style="margin-bottom:10px;">
					            	...
					            	<?php if ($_SESSION['SESS_FIRST_NAME']=="admin"){
					  					  echo '<a rel="facebox" href="addsyllabus.php"><input name="button" type="button" style="cursor:pointer;" value="ADD FILES"/></a>';
					  					  }
					  					  ?>
					  			</th>
					  			<th colspan=5 align=left>&nbsp;&nbsp;&nbsp;<label for="filter"><font color="white" size=3>Search</font></label> <input type="text" name="filter" value="" id="filter" size="35"/></th>
					            	</tr>
		...
		<?php
				...
				while($row = mysql_fetch_array($result))
				  {
					echo '<tr>';
					  echo '<td><div align="center">'.$row['course'].'</td>';
					  echo '<td><div align="center">'.$row['ctitle'].'</td>';
					  echo '<td><div align="center">'.$row['ccode'].'</td>';
					  echo '<td><div align="center">'.$row['teacher'].'</td>';
					  echo '<td><div align="center">'.$row['sy'].'</div></td>';
					  if ($_SESSION['SESS_FIRST_NAME']=="admin"){
					  echo '<td><div align="center">'.'<a href=download.php?id=' . $row["content"] .'&amp;downloadby=argie>download</a>'.' | '.'<a rel="facebox" href=editmemo.php?id=' . $row["s_id"] .'><img src="images/b_edit.png" /></a>'.' </div></td>';
					echo '</tr>';
						}
					  if ($_SESSION['SESS_FIRST_NAME']!="admin"){
